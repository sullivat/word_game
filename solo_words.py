...
# My implementation of the MIT 6.00 Word Game
...
def loadWords():
    ...
    # wordList: dict of strings
    wordList = dict()
    for line in inFile:
        wordList[line.strip().lower()] = 1
...
def isValidWord(word, hand, wordList):
    ...
    word: string
    hand: dictionary (string -> int)
    wordList: dict of lowercase strings
    """
    hand_copy = dict(hand)
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(temp_hand) > 0:
        ...
        if word == ".":
            ...
            if isValidWord(word, temp_hand, wordList) is False:
